...
const StatsDashboard = ({
  ...
  // Determine availability per platform
      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          {platformStatus.leetcode ? (
            <Link to={`/leetcode-profile/${username}`} className="block hover:scale-105 transition-transform">
          ...
          {platformStatus.codechef ? (
            <Link to={`/codechef-profile/${username}`} className="block hover:scale-105 transition-transform">
          ...
          {platformStatus.codeforces ? (
            <Link to={`/codeforces-profile/${username}`} className="block hover:scale-105 transition-transform">
          ...
          {/* GFG */}
          {platformStatus.gfg ? (
            <Link to={`/gfg-profile/${username}`} className="block hover:scale-105 transition-transform">
        ...
        {!Object.values(platformStatus).every(Boolean) && (
          <div className="mt-8 bg-yellow-400/10 border border-yellow-400/30 rounded-xl p-4 text-center">
            <p className="text-yellow-300 mb-2">Add missing profiles to unlock full dashboard features</p>
            <Link to="/profile" className="inline-flex items-center text-yellow-400 hover:text-yellow-300 font-medium">
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800">
      ...
      <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
        <div className="max-w-2xl bg-slate-800 rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Complete Your Profile</h2>

          <p className="text-slate-300 mb-8">
            To view your comprehensive stats dashboard, please add your competitive programming platform usernames to your
            profile. We'll use these to fetch your latest performance data.
          </p>
